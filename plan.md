...
**Next:** Steps 1–9 are merged and issues #1–#9 are closed; Step 9 landed on 2026-09-07 after a stop-and-audit halt, a completeness-critic correction of the audit, and three coordinator-run fix rounds with executed red-on-garbage verification. Resume `/build-phase --plan plan.md` at Step 10 (Print and pagination hardening, issue #10); the planning-to-build transition above is finished and must not be re-run.
...
- **Start-cmd:** `npm --prefix frontend run dev`
- **URL:** `http://127.0.0.1:4311`
- **Files:** `frontend/src/shared/worksheet/types.ts`, `frontend/src/shared/worksheet/invariants.ts`, `frontend/src/shared/worksheet/limit-labels.ts`, `frontend/src/shared/worksheet/limit-labels.test.ts`, `frontend/src/shared/worksheet/project-request.ts`, `frontend/src/shared/worksheet/registry.ts`, `frontend/src/web/App.tsx`, `frontend/src/web/generator/GeneratorControls.tsx`, `frontend/src/web/generator/create-session.ts`, `frontend/src/web/generator/options.test.tsx`, `frontend/src/web/preview/InstructionalVisual.tsx`, `frontend/src/web/profiles/ProfileEditor.test.tsx`, `frontend/src/web/worksheets/registry.test.ts`, `frontend/src/worksheets/count-compare-make/definition.ts`, `frontend/src/worksheets/count-compare-make/generator.ts`, `frontend/src/worksheets/count-compare-make/generator.test.ts`, `frontend/src/worksheets/dry-math/definition.ts`, `frontend/src/worksheets/dry-math/generator.ts`, `frontend/src/worksheets/find-the-wow/definition.ts`, `frontend/src/worksheets/find-the-wow/generator.ts`, `frontend/tests/e2e/options.spec.ts`, `frontend/tests/integration/envelope-single-source.test.ts`, `frontend/tests/integration/plan-citations.json`, `frontend/tests/integration/shipped-profile-options.test.ts`
